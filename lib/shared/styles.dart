...
class Styles {
  ...
  TextStyle defaultTitleStyle = TextStyle(fontSize: 18, color: Color(0xFFFF8000), letterSpacing: 1.3);
  Color defaultPrefixIconColor = Colors.white; double defaultPrefixIconSize = 32.0;
  Color formPrefixIconColor = Color(0xFFFF8000);
  TextStyle snackbarTitleStyle = TextStyle(fontSize: 17, color: Colors.white, letterSpacing: 1.1);

  Color successIconColor = Color(0xFFFF8000);
  Color errorIconColor = Colors.red;
  double messageDialogIconSize = 30;
  int snackbarMessageDuration = 4000;
}
